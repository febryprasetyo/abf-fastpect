          ...
          <div className='max-w-xl w-4/12 bg-white mr-8 '>
            ...
            <div>
              <div className=' flex min-h-full items-end justify-center p-1 text-center '>
                <div className='h-[30px] w-[30px] rounded-full bg-green-500 mr-2'></div>
                <div
            ...
            <div className=' relative overflow-visible '>
              <div className='absolute lg:top-36 lg:end-24 sm:top-24 sm:end-10 '>
                ...
                <div className='h-[30px] w-[30px] absolute end-0  rounded-full bg-green-500 mt-2'></div>
              </div>
            </div>
            {/* liquid valve */}
            <div>
          ...
          <div className='max-w-xl flex-none w-8/12'>
              ...
              <div className='grid grid-cols-4 gap-2 relative  items-center justify-between'>
                ...
                <div className='h-10 bg-white items-center flex justify-center'>
                  <h2 className=' text-center '>
                    {dataMonitoring['Cold storage temperature 1']} {`\u00B0C`}
                  </h2>
                </div>
                <div className='h-10 bg-white items-center flex justify-center'>
                ...
                <div className='h-10 bg-white items-center flex justify-center'>
                  <h2 className=' text-center '>
                    {dataMonitoring['average temperature']} {`\u00B0C`}
                  </h2>
                </div>
              </div>
            </div>
            <div className='mt-2'>
              <div className='grid grid-cols-4 gap-2 relative  items-center justify-between'>
                ...
                <div className='h-10 bg-white items-center flex justify-center'>
                  <h2 className=' text-center '>
                    {dataMonitoring['Cold storage temperature 2']} {`\u00B0C`}
                  </h2>
                </div>
                <div className='h-10 bg-white items-center flex justify-center'>
                ...
                <div className='h-10 bg-white items-center flex justify-center'>
                  <h2 className=' text-center '>
                    {dataMonitoring['Defrosting temperature']} {`\u00B0C`}
                  </h2>
                </div>
              </div>
            </div>
